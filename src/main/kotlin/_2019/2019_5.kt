...
private val day5Intcode = object : Intcode {
...
fun day5Tests(intcode: Intcode) {
    ...
    run {
        ...
        test(
            "Prints input 5",
            { intcode.run(example, input = 5).output },
            expected = listOf(5)
        )
        test(
            "Prints the input 15",
            { intcode.run(example, input = 15).output },
            expected = listOf(15)
        )
    }
    ...
    run {
        test(
            "Day 5 Part 1",
            { intcode.run(readFile("/2019_5.txt"), input = 1).output },
    ...
    run {
        ...
        test(
            ...
            { intcode.run("3,9,8,9,10,9,4,9,99,-1,8", input = 8).output.last() },

            expected = 1
        )
        test(
            "Equal - Position mode input != 8 -> 0",
            { intcode.run("3,9,8,9,10,9,4,9,99,-1,8", input = 4).output.last() },
            expected = 0
        )
        ...
        test(
            ...
            { intcode.run("3,9,7,9,10,9,4,9,99,-1,8", input = 7).output },
            expected = listOf(1)
        )
        test(
            "Less Than - Position mode, input = 8 -> 0",
            { intcode.run("3,9,7,9,10,9,4,9,99,-1,8", input = 8).output },
            expected = listOf(0)
        )
        test(
            "Less Than - Position mode, input = 9 -> 0",
            { intcode.run("3,9,7,9,10,9,4,9,99,-1,8", input = 9).output },
            expected = listOf(0)
        )
        ...
        test(
            ...
            { intcode.run("3,3,1108,-1,8,3,4,3,99", input = 8).output },
            expected = listOf(1)
        )
        test(
            "Equal - Immediate mode, input = 7 -> 0",
            { intcode.run("3,3,1108,-1,8,3,4,3,99", input = 7).output },
            expected = listOf(0)
        )
        ...
        test(
            ...
            { intcode.run("3,3,1107,-1,8,3,4,3,99", input = 7).output },
            expected = listOf(1)
        )
        test(
            "Less Than - Immediate mode, input = 8 -> 0",
            { intcode.run("3,3,1107,-1,8,3,4,3,99", input = 8).output },
            expected = listOf(0)
        )

        test(
            "Less Than - Immediate mode, input = 8 -> 0",
            { intcode.run("3,3,1107,-1,8,3,4,3,99", input = 9).output },
            expected = listOf(0)
        )
        ...
        test(
            ...
            { intcode.run("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9", input = 0).output },
            expected = listOf(0)
        )
        test(
            "Jump - Position mode, input = 1 -> 1",
            { intcode.run("3,12,6,12,15,1,13,14,13,4,13,99,-1,0,1,9", input = 1).output },
            expected = listOf(1)
        )
        test(
            "Jump - Position mode, input = -1 -> 1",
        ...
        test(
            ...
            { intcode.run("3,3,1105,-1,9,1101,0,0,12,4,12,99,1", input = 0).output },
            expected = listOf(0)
        )
        test(
            "Jump - Immediate mode, input = 1 -> 1",
            { intcode.run("3,3,1105,-1,9,1101,0,0,12,4,12,99,1", input = 1).output },
            expected = listOf(1)
        )
        test(
            "Jump - Immediate mode, input = -1 -> 1",
        ...
        test(
            ...
            { intcode.run(longProgram, input = 7).output },
            expected = listOf(999)
        )
        test(
            "Long program - input = 8 -> 1000",
            { intcode.run(longProgram, input = 8).output },
            expected = listOf(1000)
        )
        test(
            "Long program - input = 9 -> 1001",
            { intcode.run(longProgram, input = 9).output },
    ...
    run {
        test(
            "Day 5 - Part 2",
            { intcode.run(readFile("/2019_5.txt"), input = 5).output },
